      ...
      <div className="px-4 pt-6">
        ...
        >
          ...
          <div>
            ...
            <div className="w-full bg-navy-lighter/50 border border-white/5 rounded-xl px-4 py-3 text-sm text-foreground font-semibold">
          ...
          <div className="flex items-center gap-4 pt-2">
            <div className="flex items-center gap-2 flex-1">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[11px] font-bold text-gold">{TOKEN_SYMBOL}</span>
              </div>
